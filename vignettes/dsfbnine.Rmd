...
```{r gotermAnalysisexample}
DESeqresults <- readRDS(here::here("inst/extdata/dge_results")) #load the data object of class "DESeqResults"

gotermAnalysis_example <- function(dge_results, L2FC = 1, padjusted = 0.01, ontologytype = "BP", pcutoff = 1, test_direction = "over", upregulated = TRUE) {
  if(upregulated == TRUE){
...
gotermAnalysis_results <- gotermAnalysis_example(DESeqresults)
```
